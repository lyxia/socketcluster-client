...
SCTransport.prototype.endListener = function (eventName) {
  this._listenerDemux.end(eventName);
};

SCTransport.prototype.endAllListeners = function () {
  this._listenerDemux.endAll();
};
...
SCTransport.prototype._handleTransmittedEventObject = async function (obj, message) {
